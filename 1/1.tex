...
Dla pozostałych przypadków: $n=8$, $n=9$, $n=10$, możemy sprawdzić, że również zachodzi $I_{33}(n) - I_{22}(n) > 0$.
...
% i33 = lambda n: log2(n) - (6*log2(3) + (n-6)*log2(n-6)) /(n)
% i22 = lambda n: log2(n) - (4 + (n-4)*log2(n-4))/(n)
% diff = lambda n: i33(n) - i22(n)
